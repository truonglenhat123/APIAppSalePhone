...
namespace APIAppSalePhone.Repository
{
    public class AccountRepository : IAccountRepository
    {
        ...
        public LoginRes SignIn(LoginModel model)
        {
            ...
            Account accountResult = _context.Accounts.FirstOrDefault(x => x.Email == model.Email && x.Password == model.Password);
            ...
            var authClaims = new List<Claim>
            {
                new Claim(ClaimTypes.Email,model.Email),
                 new Claim("AccountId", accountResult.AccountId.ToString()),
            ...
            loginRes.Token = tokenJWT;
            loginRes.Email = accountResult.Email;
            loginRes.Id = accountResult.AccountId;
            return loginRes;
        }
